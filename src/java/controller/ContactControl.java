 ...
 *
 * <pre>
 * Class ContactControl lấy dữ liệu từ database thông qua class ContactDAO và đẩy dữ
 * liệu lên Contact.jsp để hiển thị lên trình duyệt. Trong class này sẽ tiến hành
 * các xử lí dưới đây.
 *
 * . ProcessRequest.
 * . DoGet.
...
public class ContactControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //Lấy ra từ database 1 contact và lưu vào biến contact
